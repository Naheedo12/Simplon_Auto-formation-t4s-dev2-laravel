...
<body class="bg-green-50 min-h-screen">
  <div class="max-w-5xl mx-auto p-6">
    <header class="flex justify-between items-center mb-6">
      ...
      <a href={{route('services.create')}} class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg">+ New Service</a>
    </header>
    ...
    <table class="w-full bg-white shadow rounded-lg">
     ...
     @foreach ($services as $service)
          ...
          <td class="px-4 py-3 text-right">
            <a href={{route('services.show',$service->id )}} class="text-violet-600 font-bold hover:underline mr-2">Show</a>
            <a href={{route('services.edit',$service->id )}} class="text-blue-700 font-bold hover:underline mr-2">Edit</a>
            <a href={{route('services.destroy',$service->id )}} class="text-red-600 font-bold hover:underline">Delete</a>
          </td>
        </tr>
     @endforeach
      </tbody>
